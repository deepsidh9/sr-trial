...
def enhance(testset_name = 'set_real',test_image = 'ref.png',scale_factor=4):
    ...
    sf = scale_factor                  # scale factor, only from {1, 2, 3, 4}
...
#    kernel = kernels[0, sf-2].astype(np.float64)
    ...
    result_name = testset_name + '_x' + str(sf)
    ...
    if save_E:
        util.imsave(img_E, os.path.join(E_path, img_name+'_x'+str(sf)+'.png'))
...
if __name__ == '__main__':
    ...
    enhance(testset_name = 'set_real',test_image = 'ref.png',scale_factor=2)
